            ...
            actions: [
              {
                ...
                onClick: (data) =>
                  this.isCustomer
                    ? this.router.navigate(['customer-account', data.id, 'password'])
                    : this.router.navigate(['internal-account', data.id, 'password']),
              },
              {
                icon: () => 'la-edit',
                color: () => '#40A9FF',
                ...
                onClick: (data) =>
                  this.isCustomer
                    ? this.router.navigate(['customer-account', data.id, 'edit'])
                    : this.router.navigate(['internal-account', data.id, 'edit']),
              },
              {
                icon: () => 'la-trash',
                color: () => '#dc2626',

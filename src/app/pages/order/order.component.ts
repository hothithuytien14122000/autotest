          ...
          tableItem: {
            ...
            actions: [
              ...
              },
              {
                ...
                onClick: (data) => this.router.navigate(['order', data.id]),
              },
              {
                icon: () => 'la-file-excel',
                color: () => '#40A9FF',
                ...
                onClick: (data) => this.router.navigate(['/order', data.id, 'claims']),
              },
              {
                ...
                onClick: (data) => this.router.navigate(['/order', data.id, 'paymentContent']),
              },
              {
                icon: () => 'la-exclamation',
                color: () => '#40A9FF',
